...
namespace EstockMarket.ViewModels
{
    public class JWTManagerRepository : IJWTManagerRepository
    {
        Dictionary<string, string> UserRecords;
        private readonly IConfiguration configuration;
        private readonly EstockMarketContext db;

        public JWTManagerRepository(IConfiguration _configuration, EstockMarketContext _db)
        {
            db = _db;
